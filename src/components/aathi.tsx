...
//                 formData.append('audio', audioBlob, 'audio.wav'); // Correctly append the audio blob
...
//                 try {
//                     const response = await fetch('http://127.0.0.1:5001/bigcommerce-widgets/us-central1/processAudio', {
//                         method: 'POST',
//                         body: formData,
//                     });
...
//             const formData = new FormData();
//             formData.append('audio', audioBlob, 'audio.wav'); // Correct file name for 'audio'
//             formData.append('product_data', JSON.stringify({
//                 name: product.name || 'Dummy Product Name',
//                 description: product.description || 'Dummy product description',
//                 brand: 'Dummy Brand',
...
//             try {
//                 const response = await fetch('http://localhost:5001/bigcommerce-widgets/us-central1/processAudio', {
//                     method: 'POST',
//                     body: formData,
//                 });
